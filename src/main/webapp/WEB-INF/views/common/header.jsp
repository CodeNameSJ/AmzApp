...
<header class="header" id="header">
    <div class="container">
        ...
        <nav class="nav-menu" id="nav-menu">
            ...
            <a href="${pageContext.request.contextPath}/user/login" class="nav-link">Cart</a>
        </nav>
        <div class="nav-actions">
            ...
            <button class="btn btn-primary">
                <a href="${pageContext.request.contextPath}/user/login" style="color: currentColor" class="login-link">
                    Log in</a>
